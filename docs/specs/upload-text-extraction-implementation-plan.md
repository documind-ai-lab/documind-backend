...
- [x] **Step 1: e2e 테스트 repository 공유 보정**
...
- [x] **Step 4: PDF 업로드 pending 유지 테스트 추가**
...
- [x] **Step 5: 빈 TXT 업로드 FAILED 테스트 추가**
...
- [x] **Step 1: controller에 ProcessPlainTextExtractionUseCase 주입**
